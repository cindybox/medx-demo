...
class RefillRX extends Component {
  state = { rxrows: 0 };
  addRxRows = e => {
    e.preventDefault();
    ...
    return (
      <div className="container-fluid row py-5 ">
        <div className="col-9 mx-auto py-5">
          <h2 className="text-header2 text-darkblue my-4">Welcome Back</h2>
            ...
            <div class="form-group mb-5">
              ...
              <div class="form-row ">
                <div className="col-12 col-md-4 mb-2">
                  <input type="text" class="form-control" id="rxnumber" />
                </div>
                <div className="col-12 col-md-4 mb-2">
                  <input type="text" class="form-control" id="rxnumber" />
                </div>
              ...
              <div class="form-row d-flex justify-content-end mt-2 align-items-center">
                Add More Rx Numbers &emsp;{" "}
                <ButtonRound onClick={this.addRxRows}> + </ButtonRound>
              </div>
            </div>
